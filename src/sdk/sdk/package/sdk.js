...
var MantaSdk = /** @class */ (function () {
    ...
    MantaSdk.prototype.getXCMRemoteTransactPayload = function (signResult) {
        var res = JSON.stringify(signResult.txs).slice(10);
        var raw = res.replace("[", "").replace("\"", "").replace("]", "");
        return raw;
    };
    MantaSdk.prototype.toPrivateNftSign = function (asset_id, amount, onlySign) {
        if (onlySign === void 0) { onlySign = false; }
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, to_private_nft_sign(this.api, this.signer, this.wasm, this.wasmWallet, asset_id, amount, this.network, onlySign)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, this.getXCMRemoteTransactPayload(result)];
                }
            });
        });
    };
    ...
    /// Creates an NFT collection
    /// Returns the newly created collections ID
    MantaSdk.prototype.createCollectionPayload = function (admin) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, createNFTCollectionPayload(this.api, admin)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
    ...
    /// Executes a batch transaction of minting the NFT and setting the metadata at once.
    MantaSdk.prototype.mintNFTAndSetMetadataPayload = function (collectionId, itemId, address, metadata) {
        if (address === void 0) { address = ""; }
        return __awaiter(this, void 0, void 0, function () {
            var targetAddress, _a, signRes, assetId;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, createNFTAndSetMetadataPayload(this.api, this.wasm, this.wasmWallet, this.network, collectionId, itemId, targetAddress, this.signer, metadata)];
                    case 1:
                        _a = _b.sent(), signRes = _a[0], assetId = _a[1];
                        // let signResult = await signRes.method.toHex();
                        // return [this.getXCMRemoteTransactPayload(signRes, assetId];
                        return [2 /*return*/, [signRes, assetId]];
                }
            });
        });
    };
...
function to_private_nft_sign(api, signer, wasm, wasmWallet, asset_id, to_private_amount, network, onlySign) {
    return __awaiter(this, void 0, void 0, function () {
        var asset_id_arr, txJson, transaction, assetIdNumber, signResult, res, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    if (!onlySign) return [3 /*break*/, 3];
                    return [4 /*yield*/, sign_transaction("NFT", assetIdNumber, api, wasm, wasmWallet, null, transaction, network)];
                case 2:
                    signResult = _a.sent();
                    return [2 /*return*/, signResult];
                case 3: return [4 /*yield*/, sign_and_send_without_metadata("NFT", assetIdNumber, wasm, api, signer, wasmWallet, transaction, network)];
                case 4:
                    res = _a.sent();
                    console.log("📜to_private done");
                    return [2 /*return*/, res];
...
/// Create NFT collection
/// Returns Collection Id of newly created collection.
function createNFTCollectionPayload(api, signer) {
    return __awaiter(this, void 0, void 0, function () {
        var collectionId, submitExtrinsic, e_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 2:
                    submitExtrinsic = _a.sent();
                    return [2 /*return*/, [submitExtrinsic, collectionId]];
                case 3:
                    e_6 = _a.sent();
...
function createNFT(api, wasm, wallet, network, collectionId, itemId, address, signer) {
    return __awaiter(this, void 0, void 0, function () {
        var private_address, uint8array, paddress_sha256, metadata, assetId, mintExtrinsic, registerAssetExtrinsic, batchTx, e_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
...
function createNFTAndSetMetadata(api, wasm, wallet, network, collectionId, itemId, targetAddress, signer, metadata) {
    return __awaiter(this, void 0, void 0, function () {
        var private_address, uint8array, paddress_sha256, assetManagerMetadata, assetId, mintExtrinsic, registerAssetExtrinsic, setMetadataExtrinsic, batchTx, e_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 8, , 9]);
...
/// Mint NFT and set metadata in one call.
function createNFTAndSetMetadataPayload(api, wasm, wallet, network, collectionId, itemId, targetAddress, signer, metadata) {
    return __awaiter(this, void 0, void 0, function () {
        var private_address, uint8array, paddress_sha256, assetManagerMetadata, assetId, mintExtrinsic, registerAssetExtrinsic, setMetadataExtrinsic, batchTx, e_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
                ...
                case 6:
                    batchTx = _a.sent();
                    return [2 /*return*/, [batchTx, assetId]];
                case 7:
                    e_10 = _a.sent();
                    console.log("Failed to update NFT item of Collection ID: " + collectionId + " and Item ID: " + itemId);
                    console.error(e_10);
...
function allNFTsInCollection(api, collectionId, address) {
    return __awaiter(this, void 0, void 0, function () {
        var CALAMARI_PRIVATE_SS58_ADDRESS, publicOwnedNfts, allPrivateNftsInCollection, publicOwnedNFTs, privateNFTsInCollection, i, readableResult, metadata, formatted, i, readableResult, metadata, formatted, result, e_12;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function to_private_nft(signer, api, wasm, wasmWallet, asset_id, network) {
    return __awaiter(this, void 0, void 0, function () {
        var asset_id_arr, txJson, transaction, assetIdNumber, res, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("to_private NFT transaction...");
...
function publicTransferNFT(api, signer, assetId, address) {
    return __awaiter(this, void 0, void 0, function () {
        var asset_id_arr, u8ArrayNFTAmount, tx, batchTx, e_13;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
